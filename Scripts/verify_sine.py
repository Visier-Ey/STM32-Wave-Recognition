...
def main():
    ...
    parser.add_argument('--fs', type=float,   default=1000000, 
                       help='采样率Hz (默认:1MHz)')
    parser.add_argument('--freq', type=float, default=20000.0, 
    ...
    parser.add_argument('--noise', type=float, default=0.005, 
                       help='测试噪声水平 (默认:0.05)')
    parser.add_argument('--output', type=str, default='waveform_data', 
                       help='输出文件名前缀 (默认:waveform_data)')
    parser.add_argument('--model', type=str, default='waveform_cnn_256.h5', 
                       help='模型文件路径 (默认:waveform_cnn_transformer_256.h5)')
