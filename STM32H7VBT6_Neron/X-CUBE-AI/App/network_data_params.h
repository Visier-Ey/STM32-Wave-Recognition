...
#define AI_NETWORK_DATA_ACTIVATIONS_SIZES \
  { 4416, }
#define AI_NETWORK_DATA_ACTIVATIONS_SIZE     (4416)
#define AI_NETWORK_DATA_ACTIVATIONS_COUNT    (1)
#define AI_NETWORK_DATA_ACTIVATION_1_SIZE    (4416)



#define AI_NETWORK_DATA_WEIGHTS_SIZES \
  { 65616, }
#define AI_NETWORK_DATA_WEIGHTS_SIZE         (65616)
#define AI_NETWORK_DATA_WEIGHTS_COUNT        (1)
#define AI_NETWORK_DATA_WEIGHT_1_SIZE        (65616)
